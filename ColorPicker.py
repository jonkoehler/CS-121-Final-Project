...
rBright = 0	#values of each color
gBright = 0
bBright = 0
abort = False         #set the kill switch to false
pi = pigpio.pi()      #the program it's interacting with 

#This function was taken from an open source script. This was NOT written by us
...
#makes sure the values or the colors do not exceed 255 or go less than 0
def checkBright():
    global rBright 
    global bBright 
    global gBright
